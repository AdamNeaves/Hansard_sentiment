...
\label{sec:bck_NLP}
%TODO NEEDS CITATIONS TO BACK UPM STATEMENTS
...
%TODO Explain why each is relevent to the project
...
%TODO explain what stance analysis is
...
%TODO what else did you look at? mention spacy
...
%TODO need a summary of work that the project will undertake, following on from analysis
...
%TODO Why did you choose FDD? Need list of features for project
...
%TODO each chapter should have some sort of conclusion paragraph to lead the reader on to the next chapter