...
%TODO explain inputs and outputs
...
%TODO mockup interface, example search and reponse. Basically this needs more detail
...
%TODO what size were the files that were being generated?
...
\subparagraph{Naive Bayes} %TODO MORE DETAIL ON NAIVE BAYES GOD DAMMIT
